...
class DnDRulesService {
    ...
    async getSpellDetails(spellName, castAtLevel = null) {
        ...
        try {
            ...
            const apiName = spellName.toLowerCase().replace(/ /g, '-');
            const url = `${this.baseUrl}/spells/${apiName}`;
    ...
    async getMonsterStats(monsterName) {
        ...
        try {
            const apiName = monsterName.toLowerCase().replace(/ /g, '-');
            const url = `${this.baseUrl}/monsters/${apiName}`;
    ...
    async getItemDetails(itemName) {
        ...
        try {
            const apiName = itemName.toLowerCase().replace(/ /g, '-');
            const url = `${this.baseUrl}/equipment/${apiName}`;
    ...
    async getRuleInfo(ruleName) {
        ...
        try {
            const apiName = ruleName.toLowerCase().replace(/ /g, '-');
            const url = `${this.baseUrl}/rule-sections/${apiName}`;
